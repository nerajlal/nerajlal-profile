  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div class="flex flex-col space-y-1.5 p-6">
            ...
            <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-muted-foreground text-sm mt-2">
              <div class="flex items-center gap-1">
                ...
                <span class="font-medium">Task19 Technologies</span>
              </div>
              <div class="flex items-center gap-1">
                <!-- Icon: Calendar -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
          ...
          <div class="flex flex-col space-y-1.5 p-6">
            ...
            <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-muted-foreground text-sm mt-2">
              <div class="flex items-center gap-1">
                <!-- Icon: Building -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>
                <span class="font-medium">QSpiders, Kochi</span>
              </div>
              <div class="flex items-center gap-1">
                <!-- Icon: Calendar -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
          ...
          <div class="flex flex-col space-y-1.5 p-6">
            ...
            <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-muted-foreground text-sm mt-2">
              <div class="flex items-center gap-1">
                <!-- Icon: Building -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>
                <span class="font-medium">Serve Techno Research</span>
              </div>
              <div class="flex items-center gap-1">
                <!-- Icon: Calendar -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
      ...
      <div class="space-y-6">
        <h3 class="text-2xl font-semibold mb-6 flex items-center gap-3">
          <!-- Icon: Award -->
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 text-primary"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
          Key Achievements
        </h3>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-sm bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-300 animate-slide-up group" style="animation-delay: 600ms;">
            <div class="p-4">
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  <h4 class="font-semibold mb-1">Winner - 24-hour Hackathon</h4>
                  <p class="text-sm text-muted-foreground mb-1">IEDC Kerala</p>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-sm bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-300 animate-slide-up group" style="animation-delay: 750ms;">
            <div class="p-4">
              <div class="flex items-start gap-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-primary mt-1 group-hover:scale-110 transition-transform"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
                <div class="flex-1">
                  <h4 class="font-semibold mb-1">Campus Ambassador</h4>
                  <p class="text-sm text-muted-foreground mb-1">Devtown, GDSC, Microsoft Learn</p>
                  <p class="text-xs text-muted-foreground">2023</p>
                </div>
              </div>
            </div>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-sm bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-300 animate-slide-up group" style="animation-delay: 900ms;">
            <div class="p-4">
              <div class="flex items-start gap-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-primary mt-1 group-hover:scale-110 transition-transform"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
                <div class="flex-1">
                  <h4 class="font-semibold mb-1">Freecodecamp Certifications</h4>
                  <p class="text-sm text-muted-foreground mb-1">Freecodecamp.org</p>
                  <p class="text-xs text-muted-foreground">2023</p>
                </div>
              </div>
            </div>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-sm bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-300 animate-slide-up group" style="animation-delay: 1050ms;">
            <div class="p-4">
              <div class="flex items-start gap-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-primary mt-1 group-hover:scale-110 transition-transform"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
                <div class="flex-1">
                  <h4 class="font-semibold mb-1">2nd Place - Coding & Debugging Challenge</h4>
                  <p class="text-sm text-muted-foreground mb-1">Intercollege Event</p>
