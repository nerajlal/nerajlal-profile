...
<body class="bg-slate-900 text-slate-200">
  ...
  <!-- HERO START -->
  <div class="relative container mx-auto p-7 pt-36 md:pt-44 bg-image rounded-2xl">
    <h4 class="text-lg font-semibold text-zinc-50" align="right">Java Full Stack Developer</h4>
  ...
  <div class="container mx-auto my-10">
    <div class="slide ease-linear flex space-x-6">
      ...
      <img class="w-12 h-12" src="assets/img/tech/java1.svg" alt="Java" />
      <img class="w-12 h-12" src="assets/img/tech/react.svg" alt="React" />
  ...
  <div class="container mx-auto my-14 md:my-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10" name="about">
      <div>
        ...
        <br>
        <h2 class="text-3xl font-bold mb-5">Java Full Stack Developer</h1>
...
<center>
  ...
  <div class="container max-w-6xl mx-auto flex mt-20 py-5 justify-center bg-image rounded-t-3xl">
